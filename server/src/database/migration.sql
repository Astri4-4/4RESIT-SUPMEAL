...
('Arachides', 'peanuts', 'Allergies'),
('Fruits à coque', 'tree_nuts', 'Allergies'),
('Œufs', 'eggs', 'Allergies'),
('Soja', 'soy', 'Allergies'),
('Crustacés', 'shellfish', 'Allergies'),
('Aucun', 'none', 'Éviter'),
('Porc', 'pork', 'Éviter'),
('Produits laitiers', 'dairy', 'Éviter'),
('Fruits de mer', 'seafood', 'Éviter'),
('Poissons', 'fish', 'Éviter'),
('Abats', 'offal', 'Éviter'),
('Champignons', 'mushrooms', 'Éviter'),
('Oignons', 'onions', 'Éviter'),
