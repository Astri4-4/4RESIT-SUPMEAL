...
export default function Button({icon=null, text, variant="primary", ...props}) {

    return (
        <div className={variants[variant] + " transition border border-black rounded-[10px] px-4 py-[7px] flex items-center justify-center gap-8 group"} {...props}>
            {
                icon && (
